...
namespace weavess {
    ...
    class ComponentRefineGuided : public ComponentRefine {
    public:
        explicit ComponentRefineGuided(Index *index) : ComponentRefine(index) {}

        void RefineInner() override;

    };

    class ComponentRefineTOGGKDT : public ComponentRefine {
    public:
        explicit ComponentRefineTOGGKDT(Index *index) : ComponentRefine(index) {}
    ...
    class ComponentRefineTOGGKMC : public ComponentRefine {
    public:
        explicit ComponentRefineTOGGKMC(Index *index) : ComponentRefine(index) {}
    ...
    private:
        ...
        float GetLabel(const float* sample, int* label);
    ...
    class ComponentSearchEntryGuidedCentroid : public ComponentSearchEntry {
    public:
        explicit ComponentSearchEntryGuidedCentroid(Index *index) : ComponentSearchEntry(index) {}

        void SearchEntryInner(unsigned query, std::vector<Index::Neighbor> &pool) override;
    };

    class ComponentSearchEntryTOGGKDTCentroid : public ComponentSearchEntry {
    public:
        explicit ComponentSearchEntryTOGGKDTCentroid(Index *index) : ComponentSearchEntry(index) {}

        void SearchEntryInner(unsigned query, std::vector<Index::Neighbor> &pool) override;
    };

    class ComponentSearchEntryTOGGKMCCentroid : public ComponentSearchEntry {
    public:
        explicit ComponentSearchEntryTOGGKMCCentroid(Index *index) : ComponentSearchEntry(index) {}
    ...
    class ComponentSearchRouteTOGGKDT : public ComponentSearchRoute {
    public:
        explicit ComponentSearchRouteTOGGKDT(Index *index) : ComponentSearchRoute(index) {}

        void RouteInner(unsigned query, std::vector<Index::Neighbor> &pool, std::vector<unsigned> &res) override;
    };

    class ComponentSearchRouteTOGGKMC : public ComponentSearchRoute {
    public:
        explicit ComponentSearchRouteTOGGKMC(Index *index) : ComponentSearchRoute(index) {}
