...
public:
    ...
    void CopyHigherLevelLinksToOptIndex(char* mem_offset, long long memory_per_node_higher_level, size_t cluster_num, float **m_means);
...
private:
    void CopyHigherLinksToOptIndex(char* mem_offset, int level, size_t cluster_num, float **m_m);
    void CopyLevel0LinksToOptIndex(char* mem_offset, int level) const;
