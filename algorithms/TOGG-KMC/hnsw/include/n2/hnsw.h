...
public:
    ...
    void InitComparisonTimes(){comparison_times_ = 0;}
    ...
    void Partition_neighbors();
    void SetMean(int i, const float* u){ memcpy(m_means[i], u, sizeof(float) * data_dim_); }
